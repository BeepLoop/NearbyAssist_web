...
export default function ApplicationDetails() {
    ...
    return (
        <div className="p-8">
            <div className="border-gray-900 bg-green-600 px-4 py-2 border rounded-lg text-white">
                ...
                <div className="z-50 fixed inset-0 flex justify-center items-center">
                    ...
                    <div className="relative z-10 bg-white shadow-md p-8 rounded-md w-full max-w-xl">
                        ...
                        <div className="flex justify-center">
                            <button
                                className="border-green-600 hover:bg-green-600 mr-4 px-4 py-2 border rounded font-semibold text-green-600 hover:text-white"
                                onClick={openSecondModal}
                            >
                                Semi-verified
                            </button>
                            <button
                                className="border-green-600 hover:bg-green-600 ml-4 px-4 py-2 border rounded font-semibold text-green-600 hover:text-white"
                                onClick={openSecondModal}
                            >
                                Fully-verified
                            </button>
                        ...
                        <div className="flex justify-center py-2">
                            <button
                                className="bg-green-600 hover:bg-green-800 px-4 py-2 rounded font-bold text-white"
                                onClick={openSecondModal}
                            >
                                Accept Application
                            </button>
