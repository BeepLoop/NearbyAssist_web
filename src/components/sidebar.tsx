export default function Sidebar() {
    return (
        <div className="flex h-screen">
            {/* Sidebar */}
            <div className="flex flex-col justify-between border-gray-200 bg-green-500 w-64">
                ...
                <div className="flex-1 mt-4">
                    <ul className="space-y-4">
                        <li className="flex items-center hover:bg-green-600">
                            <svg
                ...
                <div className="p-4">
                    <button className="bg-white hover:bg-green-100 px-4 py-2 rounded-lg w-full text-green-500">
                        Logout
                    </button>
                </div>
            </div>
